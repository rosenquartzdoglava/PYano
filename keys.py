...
def getKeys():
	...
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteA.png"), x = 71, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 125, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 153, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 207, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteC.png"), x = 235, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteA.png"), x = 317, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 371, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 399, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 453, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 481, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 535, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteC.png"), x = 563, y =135, batch = keybatch))

	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteA.png"), x = 645, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 699, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 727, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 781, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteC.png"), x = 809, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteA.png"), x = 891, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 945, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 973, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 1027, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteB.png"), x = 1055, y =135, batch = keybatch))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("black.png"), x = 1109, y = 210))
	keys.append(pyglet.sprite.Sprite(pyglet.image.load("whiteC.png"), x = 1137, y =135, batch = keybatch))
